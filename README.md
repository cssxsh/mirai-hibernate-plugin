...
* `mysql:mysql-connector-java:8.0.30` - [mysql](example/mysql.hibernate.properties)
...
2. 从 [Releases](https://github.com/cssxsh/mirai-hibernate-plugin/releases) 下载`jar`并将其放入`plugins`文件夹中